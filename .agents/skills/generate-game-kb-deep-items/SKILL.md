...
description: Use when a user explicitly requests full-book item distillation after a source-grounded v5 game knowledge base has been published.
---
...
refine only `name`, `type`, and `description`. Keep, merge, drop, or patch only
