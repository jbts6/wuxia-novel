# 任务：为《书剑恩仇录》生成知识库基准数据

## 小说信息
- 小说名称：书剑恩仇录
- 作者：Unknown
- 章节数：0
- 原文路径：/Users/jbts6/Site/wuxia-novel/金庸/书剑恩仇录/书剑恩仇录.txt

## 已有角色 ID 参考
- char_chen_jia_luo: 陈家洛
- char_qian_long: 乾隆
- char_huo_qing_tong: 霍青桐
- char_xiang_xiang_gong_zhu: 香香公主
- char_wen_tai_lai: 文泰来
- char_luo_bing: 骆冰
- char_yu_yu_tong: 余鱼同
- char_xu_tian_hong: 徐天宏
- char_zhang_zhao_zhong: 张召重
- char_lu_fei_qing: 陆菲青
- char_zhou_zhong_ying: 周仲英
- char_zhou_qi: 周绮
- char_zhao_ban_shan: 赵半山
- char_wei_chun_hua: 卫春华
- char_zhang_jin: 章进
- char_chen_zheng_de: 陈正德
- char_guan_ming_mei: 关明梅
- char_yuan_shi_xiao: 袁士霄
- char_li_yuan_zhi: 李沅芷
- char_li_ke_xiu: 李可秀

## 高频提及术语（供参考）
陈家洛、张召重、徐天宏、霍青桐、文泰来、余鱼同、乾隆、骆冰、周绮、红花会、周仲英、香香公主、卫春华、赵半山、章进、陈正德、李可秀、袁士霄、关明梅、王维扬、兆惠、杭州、石双英、阿凡提、少林、蒋四根、喀丝丽、北京、回部、天山双鹰、玉如意、福康安、凝碧剑、海宁、回疆、西湖、朝廷、武当派、天山、武当、清廷、六和塔、柔云剑术、百花错拳、三分剑术、无尘道长、追魂夺命剑、皇宫、黑沙掌、少林派
