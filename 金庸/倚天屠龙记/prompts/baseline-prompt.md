# 任务：为《倚天屠龙记》生成知识库基准数据

## 小说信息
- 小说名称：倚天屠龙记
- 作者：Unknown
- 章节数：0
- 原文路径：/Users/jbts6/Site/wuxia-novel/金庸/倚天屠龙记/倚天屠龙记.txt
...
- char_yin_tian_zheng: 殷天正
- char_fan_yao: 范遥
- char_cheng_kun: 成昆
- char_xiao_zhao: 小昭
- char_yin_li: 殷离
- char_song_yuan_qiao: 宋远桥
- char_song_qing_shu: 宋青书
- char_huang_shan_nv_zi: 黄衫女子
- char_yu_lian_zhou: 俞莲舟
- char_yu_dai_yan: 俞岱岩

## 高频提及术语（供参考）
张无忌、赵敏、谢逊、张翠山、明教、周芷若、殷素素、杨逍、张三丰、灭绝师太、俞莲舟、小昭、武当派、殷梨亭、俞岱岩、少林寺、少林派、韦一笑、丐帮、范遥、宋青书、成昆、天鹰教、宋远桥、波斯、殷天正、陈友谅、杨不悔、光明顶、张松溪、殷离、武当山、昆仑派、莫声谷、乾坤大挪移、九阳神功、崆峒派、大都、华山派、冰火岛、万安寺、黛绮丝、太极拳、蝴蝶谷、灵蛇岛、昆仑山、太极剑、桃花岛、绿柳山庄、一阳指
