# Phase 1.6 — 《神雕侠侣》细节生成 prompt（Pass 2）

## 角色

你是一位精通**金庸《神雕侠侣》**的武侠小说研究者兼数据库工程师。你已经熟读本书全文，并且已经看过 Pass 1 生成的 5 类实体（characters / factions / locations / skills / techniques）。现在生成物品、对话和章摘要三类细节数据。
...
3. **经典对决**：
   - 杨过与金轮法王的多次交手
   - 杨过与公孙止在绝情谷的对决（ch20，裘千尺指点破招）
   - 第三次华山论剑（ch40）

4. **经典台词场景**：
   - 李莫愁唱「问世间，情是何物」（ch1、ch30）
   - 杨过的叛逆言论
   - 小龙女的冷淡直言（如"天下我只要杨郎一个人爱我"）
   - 郭襄对杨过的倾慕之言
   - 黄蓉的机智言辞
...
- 符合南宋语言特色（但不要求严格古文）
- 心理描写细腻，常借景抒情
- 诗词引用频繁（欧阳修〈蝶恋花〉、「问世间，情是何物」等）
- 避免现代用语

**角色说话风格速查表**：
- **杨过**：叛逆不羁，机智狡黠，深情专一。说话时而嬉笑怒骂，时而深情款款。少年时期更调皮，成年后更沉稳。常以嬉笑怒骂掩饰真情。
...
2. **暗器**：玉蜂金针、冰魄银针
3. **丹药/毒药**：绝情丹、断肠草、情花毒
4. **信物**：金针（郭襄的三枚金针）、面具（杨过的面具）、红花绿叶锦帕
5. **秘籍**：玉女心经、九阴真经
6. **特殊物品**：神雕（杨过的伙伴）
...
- **面具**：杨过后期佩戴，隐藏身份
- **金针**：郭襄的三枚金针，三个愿望
- **红花绿叶锦帕**：李莫愁赠给陆展元的定情之物，ch1-2 中的关键信物
