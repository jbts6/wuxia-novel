# 神雕侠侣 — 实体生成 prompt（Pass 1）

## 角色

你是一位精通**金庸《神雕侠侣》**的武侠小说研究者兼数据库工程师。你已经熟读本书（这是你训练语料里的已知文本），现在需要基于原文写一份完整、准确、无冲突的设定库。
...
**金庸典雅白话**：文白相间，叙事细腻，心理描写深入。对话文雅含蓄，符合宋代语言特色。常引用诗词（如「问世间，情是何物」），以景衬情。

**关键特征**：
- 以「情」为核心主题，贯穿全书
- 心理描写细腻，尤其杨过与小龙女的情感变化
- 诗词引用频繁，借古咏今
- 叙事视角以杨过为主，兼及其他角色
- 战斗场面注重招式描写，虚实结合
...
**前期（ch1-10）：杨过身世与学艺**
- ch1（风月无情）：嘉兴南湖，武三通挖坟盗尸，李莫愁复仇陆家庄，柯镇恶出场
- ch2-4：杨过出场（嘉兴孤儿），郭靖收养，送入全真教
...
- ch30：小龙女跳绝情谷底，杨过苦等十六年（"离合无常"）
- ch31-32：十六年间杨过行侠仗义，成为江湖传奇
- ch33-35：杨过请周伯通与瑛姑团聚，万兽山庄聚会，郭襄初遇杨过，三枚金针

**终章（ch36-40）：襄阳大战与华山论剑**
- ch36-38：襄阳英雄大宴，蒙古大军逼近
- ch39：杨过飞石击毙蒙哥汗，解襄阳之围
- ch40（华山之巅）：蒙古退军后群雄上华山，第三次华山论剑，新五绝：东邪（黄药师）、西狂（杨过）、南僧（一灯）、北侠（郭靖）、中顽童（周伯通），觉远携少年张君宝出场

## source_ref 锚定策略

**first_mention（首次登场）**：
- 角色第一次出场的章节
- 例：杨过 ch2，小龙女 ch5，李莫愁 ch1，郭襄 ch33

**climax（高潮事件）**：
- 角色的决定性时刻
- 例：杨过断臂 ch18，小龙女跳谷 ch30，杨过飞石击毙蒙哥汗 ch39

**resolution（结局）**：
- 角色的最终归宿
- 例：杨过与小龙女重逢 ch30，华山论剑获封西狂 ch40

**background（背景信息）**：
- 角色的身世、过往
- 例：杨康往事（追溯性提及），林朝英与王重阳（古墓派历史）
...
- **完颜萍**：暗恋杨过，容易被忽略
- **武三通**：前期出场（ch1），但后期戏份减少
- **张君宝**：仅在 ch40 出场，但是《倚天屠龙记》张三丰的少年时代
- **觉远**：仅在 ch40 出场，但携带九阳真经
...
### 本书关系图常见的错误模式
- **杨过与小龙女**：师徒 → 恋人 → 夫妻，关系有明确转折
- **杨过与郭芙**：青梅竹马 → 仇人（断臂之仇）→ 和解
- **杨过与郭襄**：一见钟情（郭襄单方面），但杨过只爱小龙女
- **李莫愁与陆展元**：单恋 → 仇恨，不要误写为恋人关系
- **公孙止与裘千尺**：夫妻反目，不要误写为单纯仇人
