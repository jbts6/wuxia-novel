...
- 作者：Unknown
- 章节数：0
- 原文路径：/Users/jbts6/Site/wuxia-novel/金庸/碧血剑/碧血剑.txt
...
- char_chong_zhen_huang_di: 崇祯皇帝
- char_gui_xin_shu: 归辛树
- char_mu_sang_dao_ren: 木桑道人
- char_he_ti_shou: 何惕守
- char_yuan_chong_huan: 袁崇焕
- char_an_da_niang: 安大娘
- char_ya_ba: 哑巴
- char_sun_zhong_jun: 孙仲君
- char_jiao_wan_er: 焦宛儿
- char_hong_sheng_hai: 洪胜海
- char_cui_qiu_shan: 崔秋山
- char_li_yan: 李岩
- char_gui_er_niang: 归二娘
- char_liu_pei_sheng: 刘培生
- char_mei_jian_he: 梅剑和
- char_feng_nan_di: 冯难敌

## 高频提及术语（供参考）
袁承志、青青、阿九、洪胜海、崔秋山、何红药、小慧、程青竹、李自成、哑巴、孙仲君、梅剑和、张朝唐、何惕守、沙天广、李岩、孙仲寿、焦宛儿、胡桂南、安大娘、归辛树、杨鹏举、华山派、曹化淳、五毒教、归二娘、北京、华山、刘培生、闯军、南京、金蛇剑、铁罗汉、袁崇焕、木桑道人、青竹帮、朱安国、张康、冯难敌、罗大千、温氏五老、混元功、应松、倪浩、玉簪、泰山、金蛇秘笈、明朝、崇祯皇帝、冯不摧
