# 任务：为《射雕英雄传》生成知识库基准数据

## 小说信息
- 小说名称：射雕英雄传
- 作者：Unknown
- 章节数：0
- 原文路径：/Users/jbts6/Site/wuxia-novel/金庸/射雕英雄传/射雕英雄传.txt
...
- char_han_bao_jv: 韩宝驹
- char_nan_xi_ren: 南希仁
- char_zhang_a_sheng: 张阿生

## 高频提及术语（供参考）
郭靖、黄蓉、欧阳锋、洪七公、黄药师、周伯通、欧阳克、丘处机、梅超风、杨康、柯镇恶、裘千仞、蒙古、朱聪、完颜洪烈、铁木真、桃花岛、穆念慈、彭连虎、陆冠英、杨铁心、梁子翁、华筝、马钰、王处一、九阴真经、韩小莹、包惜弱、韩宝驹、金国、丐帮、侯通海、沙通天、鲁有脚、程瑶迦、全金发、段天德、临安、南希仁、李萍、灵智上人、江南七怪、降龙十八掌、全真七子、全真教、一灯大师、牛家村、郭啸天、铁掌帮、张阿生
