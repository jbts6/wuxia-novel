# Knowledge Base Review Prompt（射雕英雄传）
...
| 检查项 | 说明 |
|-------|------|
| 段誉 vs 段智兴 | 段誉是天龙八部主角，段智兴（一灯大师）是本书角色，同为大理段氏但不同时代 |
| 六脉神剑 vs 一阳指 | 六脉神剑是段誉的武功，一阳指是段智兴的武功，不可混淆 |
| 乔峰 vs 洪七公 | 两人都是丐帮帮主，但相隔百年，降龙十八掌传承不同 |
| 虚竹 | 天龙八部角色，本书不出现 |
| 逍遥派 | 天龙八部门派，本书不出现 |
...
| 检查项 | 说明 |
|-------|------|
| 杨康 vs 杨过 | 杨康是本书角色，杨过是神雕主角（杨康之子），不可混淆 |
| 郭靖年龄 | 本书郭靖是少年/青年，神雕中是中年，注意区分 |
| 黄蓉年龄 | 本书黄蓉是少女，神雕中是中年妇人 |
| 欧阳锋状态 | 本书欧阳锋正常，神雕中已疯癫 |
| 周伯通 | 本书周伯通是中年，神雕中是老年 |
...
本书设定在**南宋末年**（约1200-1227年），需注意：

1. **历史人物**：铁木真（成吉思汗）、完颜洪烈（金国王子）是真实历史人物，但本书有虚构成分
2. **官职制度**：南宋官制、金国官制、蒙古部落制度需符合时代
3. **地理名称**：临安（南宋都城，今杭州）、中都（金国都城，今北京）
4. **服饰器物**：符合宋代特征，不要出现明清以后的物品
5. **语言习惯**：宋元白话风格，不要出现明清以后的词汇

## 角色语言风格速查

| 角色 | 语言特点 | 常见用词 |
|------|---------|---------|
| 郭靖 | 朴实、直率、少修辞 | "我"、"你"、"好"、"是" |
| 黄蓉 | 机敏、俏皮、善用典故 | "靖哥哥"、"傻小子"、"你这" |
| 洪七公 | 豪爽、爱吃、自称老叫化 | "老叫化"、"小丫头"、"好吃" |
| 黄药师 | 孤傲、儒雅、引经据典 | "我黄药师"、"哼"、"岂" |
| 欧阳锋 | 阴险、狡诈、表面客气 | "洪兄"、"兄弟"、"佩服" |
| 周伯通 | 童心、嘻嘻哈哈、不拘礼节 | "好玩"、"有趣"、"咱们" |
| 丘处机 | 正气、道家、引经据典 | "贫道"、"奉师命"、"奸贼" |
| 杨康 | 前期纨绔、后期阴狠 | "小王爷"、"本王"、"大胆" |
...
1. **郭靖**："蓉儿，我是个粗人，不会说话。"
2. **黄蓉**："靖哥哥，我跟你在一起，开不开心？"
3. **洪七公**："老叫化一生贪吃，为了吃你这小丫头的菜，可把看家本领都教给你啦。"
4. **黄药师**："我黄药师行事，向来独来独往，何须向人解释？"
5. **欧阳锋**："洪兄武功精进，兄弟好生佩服。"
6. **周伯通**："好玩，好玩！这拳法有趣得紧！"
7. **丘处机**："贫道丘处机，奉师命下山，专一来寻那奸贼段天德。"
8. **杨康**："我是大金国小王爷，岂能与你这草民为伍？"
...
| 降龙十八掌 | skill | 掌法，口传心授 |
| 打狗棒法 | skill | 棒法，口传心授 |
| 打狗棒 | item | 实体竹棒，丐帮帮主信物 |
| 九阴真经 | skill | 内功心法，口传心授 |
| 九阴真经（书） | item | 实体经书（如有提及） |
| 蛤蟆功 | skill | 内功，口传心授 |
| 软猬甲 | item | 实体护身宝甲 |
| 一阳指 | skill | 指法，口传心授 |
| 铁砂掌 | skill | 掌法，口传心授 |
...
1. **将"打狗棒法"列为 item**：错误，这是棒法（skill），不是竹棒（item）
2. **将"九阴真经"列为 item**：错误，这是内功心法（skill），除非明确指实体经书
3. **将"软猬甲"列为 skill**：错误，这是实体宝甲（item）
4. **将"碧玉簪"列为 skill**：错误，这是实体暗器（item）
