...
| settings | `.claude/settings.json`, `.codex/hooks.json`, `.qodercn/settings.json`, `.trae/hooks.json` | Tell the platform when to run hooks or plugins. |
...
| skills | `.claude/skills/`, `.agents/skills/`, `.qodercn/skills/`, `.zcode/skills/` | Skills that auto-trigger or can be read by AI. |
