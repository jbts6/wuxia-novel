...
- **Platform files**: `.claude/`, `.codex/`, `.cursor/`, `.opencode/`, `.kiro/`, `.gemini/`, `.qodercn/`, `.codebuddy/`, `.github/`, `.factory/`, `.pi/`, `.trae/`, `.kilocode/`, `.agent/`, `.devin/`, `.reasonix/`, `.zcode/`, and similar directories.
...
| --- | --- | --- |
| settings/config | `.claude/settings.json`, `.codex/hooks.json`, `.qodercn/settings.json`, `.trae/hooks.json` | Register hooks, plugins, extensions, or platform behavior. |
...
| skills | `.claude/skills/`, `.agents/skills/`, `.qodercn/skills/`, `.zcode/skills/` | Capability descriptions that auto-trigger or can be read on demand. |
