...
- [ ] 1.1 创建角色卡Markdown模板 (`framework/templates/character-template.md`)
- [ ] 1.2 创建功法卡Markdown模板 (`framework/templates/skill-template.md`)
...
- [ ] 3.1 编写合并脚本 (`tools/merge/merge-chapters.py`) — 输出Obsidian Markdown卡片
- [ ] 3.2 编写游戏化赋值脚本 (`tools/gamify/assign-stats.py`) — 更新YAML frontmatter
- [ ] 3.3 对天龙八部执行合并+游戏化
